...
public abstract class IWalletOperation extends PreferenceAware implements Operation {
    ...
    public String getMappedStatementId(boolean needAppName) {
        String appName = needAppName ? DalUtil.toUpperCaseWithDash(IWalletConfig.appName) + "-"
            : "";
    ...
    public String addSqlAnnotation(String orgSql) {
        ...
        String[] searchStrs = new String[] { "select", "SELECT", "insert", "INSERT", "delete",
    ...
    public String getDescription() {
        return StringUtil.isNotBlank(opConfig.getDescription()) ? opConfig.getDescription() : "No descripions";
    }
