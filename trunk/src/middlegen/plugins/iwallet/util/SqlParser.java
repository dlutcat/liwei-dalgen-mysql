...
public class SqlParser {
    ...
    public SqlParser(String sql) {
        if (logger.isDebugEnabled()) {
            logger.debug("The sql parameter is " + sql + ".");
        }
        ...
        try {
            ...
            logger.error("Failed to parse sql statement " + sql + " due to exception.", pe);
        }

        if (logger.isDebugEnabled()) {
            logger.debug("The parsed statement is " + zst + ".");
        }
    ...
    protected List getParams(ZExp exp) {
        ...
        if (exp instanceof ZQuery) {
            ...
            if (logger.isDebugEnabled()) {
                logger.debug("The number of operands for expression \"" + expression + "\" is "
                    + opNum);
            }
            ...
            if (opNum == 1) {
                ...
                if (logger.isDebugEnabled()) {
                    logger.debug("The left operand is " + ol + " with type " + ol.getClass() + ".");
                    logger.debug("The right operand is " + or + " with type " + or.getClass() + ".");
                }
                ...
                if ((ol instanceof ZConstant) && (or instanceof ZExpression)) {
                    ...
                    if (logger.isDebugEnabled()) {
                        logger.debug("The type of the left constant is " + cl.getType());
                    }
